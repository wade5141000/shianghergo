					...
					<div class="form-group">
						<div class='col-lg-offset-2 col-lg-10'>
							...
							<input id="btnAdd" type='submit' class='btn btn-primary'
								value="確認修改" /> <input type="button" class="btn btn-success"
								onclick="history.back()" value="回到上一頁"></input>
								<button type="button" class="btn btn-success" onclick="location.href='/shianghergo/hao/closeStore?id='+${store.id}">關閉商店</button>
						</div>
					</div>
				</fieldset>
			</form:form>
