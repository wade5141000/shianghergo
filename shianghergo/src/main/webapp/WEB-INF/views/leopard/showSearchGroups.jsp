						...
						<div class="row" style="height: 32px; width: 495px;">
							...
							<div class="col-10" style="padding: 0">
								<input type="text" name="title" value="${param.title}" required
									...
									placeholder="請輸入需要的商品" style="width: 87%; height: 32px;">
								<button class="layui-btn align-right" lay-submit
									lay-filter="formDemo" type="submit"
				...
				<div class="inner-cont0">
					<div class="inner-cont1 w1200">
						<div class="inner-cont2">
							<a href="commodity.jsp">所有商品</a> <a href="buytoday.jsp">今日團購</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="info-list w1200">
				<div class="SearchDiv">
					...
					<table data-toggle="table" data-sortable="true"
						...
						data-page-list="[10, 20, all]" data-search="true"
						...
						<tbody>
							...
							<c:forEach varStatus="stVar" var="GroupsG" items="${Groups}">
								<tr>
									<td><img
										src="${pageContext.request.contextPath}/res/static/img/temp.png"
										height="100"></td>
									<td>${GroupsG.name}</td>
									<td>${GroupsG.status}</td>
