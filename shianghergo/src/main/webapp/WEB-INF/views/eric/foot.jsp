...
<img src="${pageContext.request.contextPath}/res/static/img/logo4.png" width="200" height="200">
                <defs>
      ...
      <div class="col-md-9 col-sm-12" style="height:270px">
        ...
        <div class="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
          <h5 class="mb-4 font-weight-bold text-uppercase">售後服務</h5>
        <ul class="list-group">
        ...
        <div class="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
          <h5 class="mb-4 font-weight-bold text-uppercase">聯繫memememe</h5>
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <img src="https://img.icons8.com/wired/64/000000/twitter.png"></i> Twitter</a>       
          </li class="list-group-item bg-transparent border-0 p-0 mb-2">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <img src="https://img.icons8.com/wired/64/000000/google-plus.png"></i> Google+</a>
          </li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <img src="https://img.icons8.com/wired/64/000000/facebook.png"></i> Facebook</a>
          </li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <img src="https://img.icons8.com/wired/64/000000/youtube-play.png"></i> YouTube</a>
          </li>
        </ul>
        </div>
