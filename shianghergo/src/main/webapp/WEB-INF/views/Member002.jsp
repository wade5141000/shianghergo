	...
	<div style="padding-bottom: 500px;">
		<div style="padding-left: 290px; padding-right: 30px;">
			<table class="table table-hover">
				<tr id='borderA'>
					<th id='borderA' colspan="7"><img
						src="<c:url value='/images/c02.png' />" alt="...">&nbsp;${loginOK.name}的訂購紀錄</th>
				</tr>
				<tr id='borderA'>
				...
				<c:forEach var="anOrderBean" items="${MyOrderList}">
					<TR id='borderA'>
						...
						<c:if test="${anOrderBean.status==2 }">
							<TD><a
								href="${pageContext.request.contextPath}/order/${anOrderBean.id}"><button
										type="button" class="btn btn-danger">🛒點我付款去</button></a></TD>
						</c:if>
